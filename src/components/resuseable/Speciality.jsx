    ...
    <section className=" py-[50px] 2xl:py-[100px]">
      <Container>
        <Flex className="items-center flex-col lg:flex-row">
          <div className=" w-full xl:w-7/12 2xl:w-1/2 relative">
            ...
            <div className=" mt-[70px] flex items-center justify-between flex-wrap">
              {speciality.map((item, i) => (
                <p
                  key={i}
                  className=" font-medium text-lg xl:text-2xl 2xl:text-[24px] text-white w-full sm:w-1/2 mb-9"
                >
          ...
          <div className=" w-full xl:w-5/12 2xl:w-1/2">
