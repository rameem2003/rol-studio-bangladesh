...
const Services = () => {
  return (
    <section className=" py-[80px] lg:py-[180px] relative">
      ...
      <Container>
        <h2 className=" text-3xl md:text-5xl xl:text-[46px] text-white font-bold w-auto  lg:w-[754px] capitalize">
          Cutting Edge digital Service for{" "}
          <span className=" text-[#0768D5]">growth & future</span>
        </h2>

        <p className=" w-auto mt-[33px] font-medium text-lg md:text-2xl xl:text-[26px] leading-[33px] text-white xl:w-[836px]">
        ...
        <Flex className=" mt-[77px] flex-wrap gap-5 justify-between">
          {services.map((service, i) => (
            ...
            >
              ...
              <p className=" font-medium text-base md:text-lg xl:text-[23px] leading-[30px] text-white">
                {service.description}
              </p>
            </div>
          ))}
