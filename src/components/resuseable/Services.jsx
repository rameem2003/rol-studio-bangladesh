...
const Services = () => {
  return (
    <section className=" py-[70px] xl:py-[180px] relative">
      ...
      <Container>
        <h2 className=" text-3xl md:text-4xl xl:text-[46px] text-white font-bold w-auto  lg:w-[754px] capitalize">
          Cutting Edge digital Service for{" "}
          <span className=" text-[#0768D5]">growth & future</span>
        </h2>

        <p className=" w-auto mt-[33px] font-medium text-lg md:text-xl xl:text-[26px] leading-[33px] text-white xl:w-[836px]">
        ...
        <Flex className=" mt-[77px] flex-wrap gap-5 justify-between">
          {services.map((service, i) => (
            ...
            >
              <h3 className=" font-bold text-2xl  xl:text-[44px] uppercase mb-9 text-white">
                {service.title}
              </h3>

              <p className=" font-medium text-base  xl:text-[23px] leading-[30px] text-white">
                {service.description}
              </p>
            </div>
          ))}
