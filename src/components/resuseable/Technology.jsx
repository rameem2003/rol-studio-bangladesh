...
const Technology = () => {
  return (
    <section className=" py-[80px] xl:py-[150px] relative">
      ...
      <Container>
        <h2 className=" mx-auto font-bold text-3xl md:text-4xl lg:text-[40px] text-white capitalize w-auto lg:w-[866px] text-center">
        ...
        <Flex className="mt-[80px] flex-wrap justify-between">
          {technology.map((item, i) => (
            <div
              key={i}
              className=" mb-[25px] w-auto xl:w-[348px] bg-[#0C3869] flex items-center rounded-full gap-1 xl:gap-[25px] pr-1"
            >
              <div className=" w-[80px] h-[80px] xl:w-[130px] xl:h-[130px] rounded-full bg-[#0768D5] flex items-center justify-center">
                <img
              ...
              <span className=" font-bold text-xl xl:text-[28px] text-white">
                {item.title}
              </span>
            </div>
          ))}
